...
def main():
    ...
    if args.ewc:
        ...
        for t in range(args.tasks):
            ...
            for i in range(args.epochs):
                ...
                accs_ewc, avg_acc_ewc, avg_test_loss_ewc = evaluate(
                    ewc.model,
                    test_dataloaders,
                    accs_ewc,
                    avg_acc_ewc,
    ...
    if args.gen_rep:
        ...
        for t in range(args.tasks):
            ...
            for i in range(args.epochs):
                ...
                accs_gr, avg_acc_gr, avg_test_loss_gr = evaluate(
                    GR.model,
                    test_dataloaders,
                    accs_gr,
                    avg_acc_gr,
    ...
    if args.joint_train:
        ...
        for t in range(args.tasks):
            ...
            for i in range(args.epochs):
                ...
                accs_joint, avg_acc_joint, avg_test_loss_joint = evaluate(
                    joint_model,
                    test_dataloaders,
                    accs_joint,
                    avg_acc_joint,
    ...
    plot_list_compare(
        args,
        [avg_acc_base, avg_acc_ewc, avg_acc_pn, avg_acc_gr, avg_acc_joint],
    ...
    avg_acc_joint_end = (
        [avg_acc_joint[((t + 1) * args.epochs) - 1] for t in range(args.tasks)] if args.joint_train else None
    )

    # Plot test accuracies at the end of each task
    plot_list_compare(
        args,
        [avg_acc_base_end, avg_acc_ewc_end, avg_acc_pn_end, avg_acc_gr_end, avg_acc_joint_end],
        y_desc="Average accuracy",
        x_desc="Task",
        title="",
        save=args.save_plots,
        filename=filename + "_task_end",
    )
