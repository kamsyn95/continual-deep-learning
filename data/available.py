...
AVAILABLE_TRANSFORMS = {
    ...
    "cifar10_norm": [transforms.Normalize(mean=[0.4914, 0.4822, 0.4465], std=[0.2470, 0.2435, 0.2616])],
    "cifar100_norm": [transforms.Normalize(mean=[0.5071, 0.4865, 0.4409], std=[0.2673, 0.2564, 0.2761])],
